...
- Warna aksen, tipografi navbar, dan gaya tabel/kartu mengikuti `assets/css/style.css` yang sudah dibangun sejak Jobsheet 2-3. Untuk versi Bootstrap, gaya ini setara dengan komponen `.navbar`, `.card`, dan `.table` beserta override warna brand (`#1d5b8a`) yang sudah diterapkan.
